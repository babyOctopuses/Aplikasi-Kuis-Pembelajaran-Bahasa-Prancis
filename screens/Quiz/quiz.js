...
export default class Quiz extends Component {
  ...
  componentDidMount() {
    ...
    test.get().then((res) => {
      ...
      render(){
        const allQuestions = this.state.Quiz[0];
      ...
      const renderNextButton = () => {
        ...
        return(
          <SafeAreaView style={{flex: 1}}>
            ...
            <Button title="props" onPress={()=>{console.log(this.props)}}/>
            {/* {renderProgressBar()} */}
            {renderQuestion()}
            {renderOptions()} 
            {renderNextButton()} 
                ...
                >
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <Text style={{fontSize: 30, fontWeight: 'bold'}}>{ scoreNow > (allQuestions.length/2) ? 'Congratulations!' : 'Oops!' }</Text>
                            ...
                            <View style={{
                                ...
                                <Text style={{
                                    fontSize: 30,
                                    color: scoreNow > (allQuestions.length/2) ? COLORS.success : COLORS.error
                                }}>{scoreNow}</Text>
                                 <Text style={{
